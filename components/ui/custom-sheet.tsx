...
const CustomSheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, CustomSheetContentProps>(
...
const CustomSheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-2 text-center sm:text-left", className)} {...props} />
)
CustomSheetHeader.displayName = "CustomSheetHeader"

const CustomSheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
